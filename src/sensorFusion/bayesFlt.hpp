...
#ifndef BAYESFLT_HPP_
#define BAYESFLT_HPP_
...
public:
	...
	//info style
	FM::Vec y;	//info vector
	FM::SymMatrix Y;	// info matrix

	FM::Vec y_ick;	// info contribution for state of kalman filter
	FM::SymMatrix Y_ick;	// info contribution for cov of kalman filter
