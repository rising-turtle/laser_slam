...
public:
	...
	Float observeFusion (Uncorrelated_additive_observe_model& h, const FM::Vec& z);
	Float observeFusion (Correlated_additive_observe_model& h, const FM::Vec& z);
	Float observeFusion (Linrz_uncorrelated_observe_model& h, const FM::Vec& z)
	{	// Adapt to use the more general additive model
		return observeFusion (static_cast<Uncorrelated_additive_observe_model&>(h),z);
	}
	Float observeFusion (Linrz_correlated_observe_model& h, const FM::Vec& z)
	{	// Adapt to use the more general additive model
		return observeFusion (static_cast<Correlated_additive_observe_model&>(h),z);
	}
